...
//    
//  const char* title = root["title"]; // "Lead 138"
//  const char* alloy = root["alloy"]; // "Sn42/Bi57.6/Ag0.4"
//  int melting_point = root["melting_point"]; // 138
//
//  int temp_range_0 = root["temp_range"][0]; // 30
//  int temp_range_1 = root["temp_range"][1]; // 165
//
//  int time_range_0 = root["time_range"][0]; // 0
//  int time_range_1 = root["time_range"][1]; // 390
//
//  const char* reference = root["reference"]; // "http://www.chipquik.com/datasheets/TS391LT50.pdf"
//
//  JsonObject& stages = root["stages"];
//
